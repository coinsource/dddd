...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Rockcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"54.84.39.245", "54.84.39.245"},
    {"seed1.rockcoinpool.com", "seed1.rockcoinpool.com"},
    {"seed2.rockcoinpool.com", "seed2.rockcoinpool.com"},
    {"seed3.rockcoinpool.com", "seed3.rockcoinpool.com"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("Rockcoin-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Rockcoin is probably already running."), addrBind.ToString().c_str());
        else
