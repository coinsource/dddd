...
extern json_spirit::Value testblock(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value testblock2(const json_spirit::Array& params, bool fHelp);
